  ...
  return (
    <div className="md:fixed h-[100%] w-full md:w-[70px] md:bg-[#611f69]  bg-[#1d1c1d]">
      <div className="  grid grid-cols-4 md:grid-cols-1 gap-y-4 text-white px-1 text-xs">
        <p className="bg-gray-400 text-black w-[45px] mt-3 py-1.5 text-center text-2xl font-semibold rounded-lg mx-auto mb-7 hidden md:block">
          U
        </p>
        ...
        <Link href="/contact-us" className="col-span-1">
          <TabButton
            name="Contact Us"
            isSelected={path === "/contact-us"}
            icon={
              <IoHelpCircleOutline
                className="w-6 h-6 mx-auto "
                fill="#ffffff"
